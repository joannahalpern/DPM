/*
 * Lab4- Group 53 - LightLocalization
...
//done exactly like the tutorial said
	private void calculateCurrentPosition(){
		double thetaX = (360- (angles[1]+angles[2]) )*Math.PI/180;
		double thetaY = (360- (angles[2]+angles[3]) )*Math.PI/180;
		double x = -DIST_BTW_LS_AXLE* Math.cos(thetaX/2);//DIST_BTW_LS_AXLE is the radius of the circle
	...
	private void initializeLightSensor() {
		ls.setFloodlight(true);
		ls.setFloodlight(ColorSensor.Color.GREEN); //Green is the most sensitive color :)
	}

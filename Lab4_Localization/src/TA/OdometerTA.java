...
public class OdometerTA implements TimerListener {
	...
	// constructor
	public OdometerTA (NXTRegulatedMotor leftMotor, NXTRegulatedMotor rightMotor, int INTERVAL, boolean autostart) {

...
public class oldOdometryCorrection extends Thread {
	...
	// constructor
	public oldOdometryCorrection(Odometer odometer) {
...
//					if (!firstLineX) { // if firstLineX has not been read
//						firstLineX = true;
...
//					}
	...
	public static double calculateGridOffset() {

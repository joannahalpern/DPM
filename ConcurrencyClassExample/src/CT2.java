	...
	public void run() {
		...
		while (true) {
			...
			if (status == last_press) /* Crude press determination */
				...
				last_press = status;
			/*
			 * Case 1: currently inactive, in top panel, left arrow button
			 * pressed.
			 */
			...
			/*
			 * Case 2: currently inactive, in bottom panel, right arrow putton
			 * pressed.
			 */
			...
			/*
			 * Case 3: currently active, in top panel, left arrow button
			 * pressed.
			 */
			...
			/*
			 * Case 4: currently active, in bottom panel, right arrow button
			 * pressed.
			 */
